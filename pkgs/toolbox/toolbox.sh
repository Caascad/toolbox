...
_toolbox_completions() {
  ...
  if [ "\${#COMP_WORDS[@]}" = "2" ]; then
      COMPREPLY=(\$(compgen -W "doctor completions list list-terraform-providers install uninstall update make-shell update-shell make-terraform-shell help version" "\${COMP_WORDS[1]}"))
      return
  fi
